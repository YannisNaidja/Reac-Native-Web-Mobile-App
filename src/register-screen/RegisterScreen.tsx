...
import { isMobile } from '../app/utils/IsMobile.utils';
import { primaryPurple } from '../app/utils/constants.utils';
        ...
        <Animatable.View duration={2000} animation="bounceInDown">
            <View style={tw('mt-3 pt-3 items-center')}>
                <Card containerStyle={isMobile() ? tw('w-4/6') : tw('w-1/6')}>
                    ...
                    <TextInput style={[tw('mt-3 rounded-md'), isMobile() ? tw('mb-1 ') : [tw('mb-3'), { outlineOffset: '6px', outlineColor: primaryPurple }]]} placeholder='Password'></TextInput>
                    <TextInput style={[tw('mt-3 rounded-md'), isMobile() ? tw('mb-1 ') : [tw('mb-3'), { outlineOffset: '6px', outlineColor: primaryPurple }]]} placeholder='Confirm password'></TextInput>
                    <TouchableOpacity
