    ...
    return (
        <View style={tw('mt-3 pt-3 items-center')}>
            <Card containerStyle={isMobile() ? tw('w-4/6') : tw('w-1/6')}>
                ...
                <TextInput onChangeText={onChangeUsername} onFocus={() => { }} style={[{ outlineOffset: '6px', outlineColor: primaryPurple }, tw('mt-3 rounded-md'), isMobile() ? tw('mb-1') : tw('mb-3')]} placeholder="Email or Username"></TextInput>
                <TextInput onChangeText={onChangePassword} style={[{ outlineOffset: '6px', outlineColor: primaryPurple }, tw('mt-3 rounded-md'), isMobile() ? tw('mb-1') : tw('mb-3')]} placeholder='Password'></TextInput>
                <TouchableOpacity
